...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/Users/runner/hostedtoolcache/Python/3.12.2/x64' "
                ...
                "'TCLTK_CFLAGS=-I/usr/local/opt/tcl-tk/include/tcl-tk' "
 ...
 'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow '
                          '-I/Applications/Xcode_13.2.1.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/ffi '
 ...
 'MODULE__TKINTER_CFLAGS': '-I/usr/local/opt/tcl-tk/include/tcl-tk '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/usr/local/opt/tcl-tk/lib -ltcl8.6 -ltk8.6',
